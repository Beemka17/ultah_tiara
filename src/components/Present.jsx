...
function Present() {
  return (
    <SectionWrapper>
      <div className="mb-64">
        <h1 className="absolute -top-[7rem] left-0 right-0 text-center flex items-center justify-center text-xl font-extrabold text-customBlue drop-shadow-lg">Klik untuk buka hadiah-hadiahan dari aku!</h1>
      </div>
        ...
        <label className="gift" htmlFor="click">
          ...
          <div id="raffle-red" className="entry raffle raffle-1">
            <div className="no-scale">
              <span className="ticket-text2">
                Free
                <br />
                Support Sampe lulus S1
              </span>
            </div>
          </div>
